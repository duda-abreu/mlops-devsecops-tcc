...
app = FastAPI(title="API MLOps com FastAPI", description="Predição com modelo treinado + scaler", version="1.0")
...
@app.get("/")
def home():
    return {"mensagem": "API de predição de Iris com modelo treinado e scaler."}
